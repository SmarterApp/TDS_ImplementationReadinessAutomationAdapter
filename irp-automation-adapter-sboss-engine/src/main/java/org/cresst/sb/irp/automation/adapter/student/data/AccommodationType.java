...
public class AccommodationType {
    ...
    /**
     * @param parentAccommodations the parentAccommodations to set
     */
    ...
    /**
     * @param _isVisible the _isVisible to set
     */
    ...
    /**
     * @param _isSelectable the _isSelectable to set
     */
    ...
    /**
     * @param _allowChange the _allowChange to set
     */
    ...
    /**
     * @param _studentControl the _studentControl to set
     */
    ...
    /**
     * @param _dependsOnToolType the _dependsOnToolType to set
     */
    ...
    /**
     * @param _disableOnGuestSession the _disableOnGuestSession to set
     */
