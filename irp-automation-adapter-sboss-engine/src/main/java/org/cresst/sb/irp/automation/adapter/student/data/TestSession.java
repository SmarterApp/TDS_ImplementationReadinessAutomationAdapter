...
{
  private SessionStatus.SessionStatusType _statusType;
  private String            _id;
  private UUID              _key;
  ...
  @JsonProperty ("status")
  public SessionStatus.SessionStatusType getStatusType () {
    return _statusType;
  }

  public void setStatusType (SessionStatus.SessionStatusType _statusType) {
